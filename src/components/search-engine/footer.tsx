          ...
          <div className="flex items-center gap-4 flex-wrap justify-center text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <span className="relative flex w-2 h-2">
                <span className={`absolute inline-flex w-full h-full rounded-full ${connected ? "bg-primary pulse-ring" : "bg-amber-500"} opacity-60`} />
                <span className={`relative inline-flex w-2 h-2 rounded-full ${connected ? "bg-primary" : "bg-amber-500"}`} />
              </span>
